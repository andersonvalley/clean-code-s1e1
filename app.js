...
var taskInput=document.getElementById("new-todo");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.getElementById("todo-incomplete");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    listItem.className='todo__inner'
    checkBox.className="todo__checkbox"
    label.innerText=taskString;
    label.className='todo__item todo__item-label';

    //Each elements, needs appending
    checkBox.type="checkbox";
    editInput.type="text";
    editInput.className="todo__item todo__item-input";
